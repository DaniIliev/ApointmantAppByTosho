...
export default function DashboardPage() {
  ...
  const handleEditAppointment = () => {
    if (selectedAppointment) {
      ...
      const editApoyntmantData = {
        clientName: selectedAppointment.clientName,
        email: selectedAppointment.email,
        clientPhone: selectedAppointment.clientPhone,
        date: selectedAppointment.appointmentTime.start,
        time: selectedAppointment.appointmentTime.start,
        appointmentTypeId: selectedAppointment.serviceName,
        notes: "",
        staff: selectedAppointment.staff._id,
      };
      // setEditingAppointment(editApoyntmantData);
      setIsEditMode(true);
    }
  };
  ...
  const handleCreateAppointment = async (
    ...
    const payload = {
      ...
      clientPhone: appointmentData.clientPhone,
      email: appointmentData.email,
      staff: appointmentData.staff_id,
      notes: appointmentData.notes,
    };
    try {
