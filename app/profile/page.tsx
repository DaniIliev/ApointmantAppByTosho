...
export default function ProfilePage() {
  ...
  const colorPalettes = [
    ...
    },
    {
      ...
      background: "from-slate-900 via-gray-950 to-slate-900",
      accent1: "bg-slate-500/20",
      accent2: "bg-gray-600/20",
      preview: "bg-gradient-to-r from-slate-400 to-gray-600",
    },
    {
      id: "gold-crimson",
      name: "Royal Sunset",
      primary: "from-amber-400 to-red-600",
      background: "from-slate-900 via-red-950 to-slate-900",
      accent1: "bg-amber-500/30",
      accent2: "bg-red-600/30",
      preview: "bg-gradient-to-r from-amber-400 to-red-600",
    },
    {
      id: "teal-cyan",
      name: "Deep Sea",
      primary: "from-teal-400 to-cyan-500",
      background: "from-slate-900 via-teal-950 to-slate-900",
      accent1: "bg-teal-400/30",
      accent2: "bg-cyan-500/30",
      preview: "bg-gradient-to-r from-teal-400 to-cyan-500",
    },
    {
      id: "charcoal-white",
      name: "Monochrome",
      primary: "from-white to-gray-400",
      background: "from-gray-900 via-black to-gray-900",
      accent1: "bg-white/20",
      accent2: "bg-gray-400/20",
      preview: "bg-gradient-to-r from-white to-gray-400",
    },
  ];
        ...
        <div className="bg-slate-900/40 backdrop-blur-xl border border-white/20 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2 space-y-6">
              <div>
                <label className="text-white/80 text-sm font-medium mb-4 flex items-center gap-2">
