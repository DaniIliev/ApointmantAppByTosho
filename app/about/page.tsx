      ...
      <div className="relative max-w-4xl mx-auto">
        <div className="bg-slate-900/40 backdrop-blur-xl border border-white/20 rounded-2xl p-8 shadow-2xl">
          <h1 className="text-4xl font-bold bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent mb-8">
            About AppointmentPro
          </h1>

          <div className="space-y-6 text-white/80 leading-relaxed">
            <p className="text-lg">
              AppointmentPro is a modern, intuitive appointment management system designed to streamline your business
              operations and enhance customer experience.
            </p>

            <p>
              Our platform combines cutting-edge technology with user-friendly design to provide a comprehensive
              solution for appointment scheduling, client management, and business analytics.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-12">
              <div className="bg-slate-800/30 p-6 rounded-xl border border-white/10">
                ...
                <p>
                  To empower businesses with efficient appointment management tools that save time and improve customer
                  satisfaction.
                </p>
              </div>
              ...
              <div className="bg-slate-800/30 p-6 rounded-xl border border-white/10">
                ...
                <p>
                  To become the leading appointment management platform that transforms how businesses connect with
                  their clients.
                </p>
              </div>
            </div>
