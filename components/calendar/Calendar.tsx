...
//       console.log("check", appointmentDate.toDateString() === dateString);
//       return appointmentDate.toDateString() === dateString;
//     });

//     // Връщаме филтрирания списък.
//     // Ако има търсен термин, прилагаме втори филтър.
//     if (!term) {
//       return filteredByDate;
//     }
...
//                             >
//                               <div className="font-medium">
//                                 {formatDateAndTime(apt.dateTime, "time")}
//                               </div>
//                               <div className="truncate">{apt.clientName}</div>
