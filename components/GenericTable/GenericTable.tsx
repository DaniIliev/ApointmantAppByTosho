...
export const GenericTable = <T extends Record<string, any>>({
  ...
  useEffect(() => {
    setTempData(data);
    // Reset page index when data changes or filters/sort change that affect the data array length/order
    setPagination((prev) => ({ ...prev, pageIndex: 0 }));
  }, [data, globalFilter, dateFilter, sorting.id, sorting.direction]); // Added dependencies to reset page on filter/sort change
  ...
  const getFilteredData = () => {
    // 💡 **Global Search Logic - Already Working**
    // The filter logic handles filtering by date and then by global search.
    ...
    if (dateFilter !== "all") {
      tempFilteredData = tempFilteredData.filter((item) => {
        ...
        switch (dateFilter) {
          ...
          case "future":
            // Note: If 'date' is part of T, future dates might include next_month and beyond.
            // I'll stick to the original logic which seems to be 'after next month start'.
  ...
  // 💡 **Row Count / Pagination Logic - Already Working**
  // The 'slice' method uses pagination.pageSize which controls the number of rows displayed.
      ...
      <div className="rounded-xl border shadow-lg bg-white dark:bg-gray-800/70 backdrop-blur-lg border-primary/20">
        <div className="flex flex-col md:flex-row gap-4 py-3 px-4 justify-between items-center border-b border-gray-200 dark:border-gray-700">
          <div className="relative flex-1">
            ...
            {/* 💡 **Global Search Input - Already Working** */}
            <input
              type="text"
          ...
          <div className="flex gap-2 items-center">
              ...
              <>
                {isEditing ? (
                  ...
                  <button
                    ...
                    // 💡 **Style Fix 1:** Ensures p-2 is used for consistent button size.
            ...
            <div className="relative" ref={dropdownRef}>
              <button
                // 💡 **Style Fix 2:** Ensures p-2 is used for consistent button size.
            ...
            <div className="relative group">
              <button
                ...
                // 💡 **Style Fix 4:** Ensures p-2 is used for consistent button size.
            ...
            <div className="relative group">
              <button
                ...
                // 💡 **Style Fix 5:** Ensures p-2 is used for consistent button size.
                className="p-2 border rounded-lg bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700"
              >
        ...
        <div className="overflow-x-auto">
          {/* Using paginatedData for the table rows */}
              ...
              <tr>
                {columns
                  ...
                  .map((column, index) => (
                    <th
                      key={index}
                      className="px-4 py-3 text-sm font-semibold text-gray-700 dark:text-gray-300 border-b border-r relative"
                      style={{
                    ...
                    >
                      ...
                      <div
                        ...
                        className="absolute top-0 right-0 w-2 h-full cursor-col-resize hover:bg-gray-400 dark:hover:bg-gray-600 transition-colors duration-100"
                      />
                    </th>
                  ))}
              </tr>
            ...
            <tbody>
              ...
              {paginatedData.length ? (
                paginatedData.map((row, rowIndex) => {
                  // Find the index in the filteredData (which sortedData is based on)
                    ...
                    >
                      {columns
                        ...
                        .map((column, colIndex) => (
                          <td
                            key={colIndex}
                            className={`px-4 ${getCellClass()} border-r`}
                          ...
                          >
                            {isEditing && column.editableCell
                              ? column.editableCell(
                                  { row: { original: row } },
                                  (accessorKey, value) =>
                                    // Use originalIndex for correct row update in tempData
                                    handleUpdate(
                                      originalIndex,
                                      accessorKey,
                                      value
        ...
        <div className="flex items-center justify-between px-4 py-2">
          ...
          <div className="flex items-center space-x-2">
            <div className="relative">
              {/* 💡 **Row Count Selector - Already Working** */}
              <select
            ...
            <button
              // 💡 **Pagination Button Style Fix:** Ensures consistent p-2 padding.
...
//                                 { row: { original: row } },
//                                 (accessorKey, value) =>
//                                   handleUpdate(rowIndex, accessorKey, value)
//                               )
//                             : column.cell({ row: { original: row } })}
//                         </td>
//                       ))}
